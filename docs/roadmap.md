...
| 6b | `claude/apm-06b-frontend` | NiceGUI dashboard, calling the 6a API: tool status, fetched/summarized data, pending approvals with Approve/Reject, history | The 6a API running |
